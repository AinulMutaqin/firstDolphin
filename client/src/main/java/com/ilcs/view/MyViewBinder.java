...
public class MyViewBinder extends AbstractViewBinder<MyModel> {
    ...
    protected void init() {
        ...
        FXBinder.bind(firstValue.textProperty()).bidirectionalTo(getModel().firstValueProperty());
        FXBinder.bind(secondValue.textProperty()).bidirectionalTo(getModel().secondValueProperty());
        FXBinder.bind(resultValue.textProperty()).bidirectionalTo(getModel().resultValueProperty());
